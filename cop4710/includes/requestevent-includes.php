...
if (isset($_POST["submitrequestevent"])) {
	...
	if (isEmptyRequestEvent($eventname, $eventdesc, $eventphone, $eventdate, $eventtime, $eventtime2,
	...
	if (eventExists($conn, $eventdatetime, $eventlat, $eventlong) !== FALSE) {
		header("location: ../requestevent.php?error=time_place_conflict&datetime=".$eventdatetime.
	...
	requestEvent($conn, $eventname, $eventdesc, $eventphone,
